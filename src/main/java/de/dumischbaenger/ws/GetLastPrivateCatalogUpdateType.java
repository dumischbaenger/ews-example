...
/**
 * <p>Java-Klasse für GetLastPrivateCatalogUpdateType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="GetLastPrivateCatalogUpdateType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetLastPrivateCatalogUpdateType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "client"
})
public class GetLastPrivateCatalogUpdateType

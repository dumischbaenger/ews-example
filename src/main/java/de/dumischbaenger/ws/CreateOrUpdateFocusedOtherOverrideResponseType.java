...
/**
 * <p>Java-Klasse für CreateOrUpdateFocusedOtherOverrideResponseType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="CreateOrUpdateFocusedOtherOverrideResponseType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "CreateOrUpdateFocusedOtherOverrideResponseType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "override"
})
public class CreateOrUpdateFocusedOtherOverrideResponseType

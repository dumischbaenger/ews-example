...
/**
 * <p>Java-Klasse für AddImGroupResponseMessageType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="AddImGroupResponseMessageType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AddImGroupResponseMessageType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "imGroup"
})
public class AddImGroupResponseMessageType

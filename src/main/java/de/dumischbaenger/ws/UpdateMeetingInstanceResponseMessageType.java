...
/**
 * <p>Java-Klasse für UpdateMeetingInstanceResponseMessageType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="UpdateMeetingInstanceResponseMessageType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "UpdateMeetingInstanceResponseMessageType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "meetingInstance"
})
public class UpdateMeetingInstanceResponseMessageType

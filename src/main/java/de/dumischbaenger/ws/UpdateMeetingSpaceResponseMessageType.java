...
/**
 * <p>Java-Klasse für UpdateMeetingSpaceResponseMessageType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="UpdateMeetingSpaceResponseMessageType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "UpdateMeetingSpaceResponseMessageType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "meetingSpace"
})
public class UpdateMeetingSpaceResponseMessageType

...
/**
 * <p>Java-Klasse für GetPhoneCallInformationType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="GetPhoneCallInformationType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GetPhoneCallInformationType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "phoneCallId"
})

...
/**
 * <p>Java-Klasse für AddImContactToGroupType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="AddImContactToGroupType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AddImContactToGroupType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "contactId",
    "groupId"
})
public class AddImContactToGroupType

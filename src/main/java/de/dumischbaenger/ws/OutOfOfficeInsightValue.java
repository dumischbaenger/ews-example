...
/**
 * <p>Java-Klasse für OutOfOfficeInsightValue complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="OutOfOfficeInsightValue"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "OutOfOfficeInsightValue", propOrder = {
    "startTime",
    "endTime",
    "message",
    "culture"
})
public class OutOfOfficeInsightValue

...
/**
 * <p>Java-Klasse für AddTagResponseMessageType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="AddTagResponseMessageType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AddTagResponseMessageType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "wasSuccessful"
})
public class AddTagResponseMessageType

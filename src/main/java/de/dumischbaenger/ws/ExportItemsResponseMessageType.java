...
/**
 * <p>Java-Klasse für ExportItemsResponseMessageType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="ExportItemsResponseMessageType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ExportItemsResponseMessageType", namespace = "http://schemas.microsoft.com/exchange/services/2006/messages", propOrder = {
    "itemId",
    "data"
})
